...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_pcvrset p_pcvrset;
        ...
        public static SteamVR_Input_ActionSet_pcvrset pcvrset
        {
            get
            {
                return SteamVR_Actions.p_pcvrset.GetCopy<SteamVR_Input_ActionSet_pcvrset>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_pcvrset = ((SteamVR_Input_ActionSet_pcvrset)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_pcvrset>("/actions/pcvrset")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.pcvrset};
        }
    }
}
